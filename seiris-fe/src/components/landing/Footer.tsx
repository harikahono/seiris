...
function AnimatedGroup({ children, delay = 0, className = '' }: AnimatedGroupProps) {
...
export function Footer() {
  return (
    ...
    >
      <div className="footer-fixed-panel">
        <div className="footer-inner">

          {/* Background decorative radial gradients */}
          <div aria-hidden className="footer-bg-decor">
            <div className="footer-bg-glow footer-bg-glow--1" />
            <div className="footer-bg-glow footer-bg-glow--2" />
            <div className="footer-bg-glow footer-bg-glow--3" />
          </div>
          ...
          <div className="footer-content">
            ...
            {/* Brand column */}
            <AnimatedGroup className="footer-brand" delay={0}>
            ...
            {footerLinkGroups.map((group, i) => (
              ...
              >
                <h3 className="footer-group-label">{group.label}</h3>
